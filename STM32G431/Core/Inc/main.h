...
/* Private defines -----------------------------------------------------------*/
#define adelante_Pin GPIO_PIN_1
#define adelante_GPIO_Port GPIOA
#define atraz_Pin GPIO_PIN_2
#define atraz_GPIO_Port GPIOA
...
#define I_Pin GPIO_PIN_6
#define I_GPIO_Port GPIOB
#define J_Pin GPIO_PIN_7
